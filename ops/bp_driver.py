...
class DRIVER_OT_get_vars_from_object(Operator):
    bl_idname = "bp_driver.get_vars_from_object"
    ...
    prompts: CollectionProperty(name='Collection Prompts',type=BP_prompt_collection)
    ...
    def execute(self, context):
        if self.assembly:
            for DR in self.obj.animation_data.drivers:
...
class DRIVER_OT_remove_variable(Operator):
    bl_idname = "bp_driver.remove_variable"
