...
class FILEBROWSER_PT_library_tabs(Panel):
    ...
    def draw(self, context):
        ...
        col.prop_enum(props, "library_tabs", 'SCRIPT', icon='SCRIPTPLUGINS', text="  Script") 
        col.separator()
        col.prop_enum(props, "library_tabs", 'OBJECT', icon='OBJECT_DATA', text="  Object") 
        col.prop_enum(props, "library_tabs", 'COLLECTION', icon='GROUP', text="  Collection") 
